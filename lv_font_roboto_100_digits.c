 ...
 * Size: 100 px
 * Bpp: 4
 * Opts: --no-compress --no-prefilter --bpp 4 --size 100 --format lvgl -o ../lv_font_roboto_100_digits.c --force-fast-kern-format --lv-include lvgl.h --font Roboto-Regular.ttf --range 48-57
 ******************************************************************************/
