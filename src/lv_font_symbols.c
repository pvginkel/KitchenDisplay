 ...
 * Size: 32 px
 * Bpp: 4
 * Opts: --no-compress --no-prefilter --bpp 4 --size 32 --format lvgl -o ../src/lv_font_symbols.c --force-fast-kern-format --lv-include lvgl.h --font fonts/fa-solid-900.ttf --range 0xf002,0xf060
 ******************************************************************************/
...
#ifndef LV_FONT_SYMBOLS
#define LV_FONT_SYMBOLS 1
#endif
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 512, .adv_w = 448, .box_w = 28, .box_h = 24, .ofs_x = 0, .ofs_y = 0}
};
...
{
    {
        .range_start = 61442, .range_length = 95, .glyph_id_start = 1,
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t lv_font_symbols = {
#else
lv_font_t lv_font_symbols = {
#endif
